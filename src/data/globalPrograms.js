export const globalPrograms = [
  {id:'global-fullbody',name:'Full Body 3x/semana',goal:'Força + hipertrofia',level:'Iniciante',frequency:'3 dias/semana',source:'ACSM 2026',description:'Treino de corpo inteiro com frequência simples e sustentável.',exercises:[
  ...
  {id:'global-hypertrophy',name:'Hipertrofia 4x/semana',goal:'Hipertrofia',level:'Intermediário',frequency:'4 dias/semana',source:'ACSM 2026',description:'Divisão para distribuir o volume e facilitar a progressão.',exercises:[
  ...
  {id:'global-strength',name:'Força 3x/semana',goal:'Força',level:'Intermediário',frequency:'3 dias/semana',source:'ACSM 2026',description:'Movimentos principais com foco em carga e execução consistente.',exercises:[
  ...
  {id:'global-home',name:'Treino em casa',goal:'Condicionamento',level:'Iniciante',frequency:'3 dias/semana',source:'ACSM 2026',description:'Rotina prática usando principalmente peso corporal.',exercises:[

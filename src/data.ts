...
export const plans=[
{id:'full-a',name:'Full Body A',frequency:'3x por semana',duration:'45–60 min',level:'Iniciante',goal:'Força + hipertrofia'},
{id:'full-b',name:'Full Body B',frequency:'3x por semana',duration:'45–60 min',level:'Iniciante',goal:'Força + hipertrofia'},
{id:'abc',name:'ABC Hipertrofia',frequency:'3x por semana',duration:'50–70 min',level:'Intermediário',goal:'Hipertrofia'},
{id:'ppl',name:'Push / Pull / Legs',frequency:'3–6x por semana',duration:'50–75 min',level:'Intermediário',goal:'Hipertrofia + força'},
{id:'upper-lower',name:'Upper / Lower',frequency:'4x por semana',duration:'50–70 min',level:'Intermediário',goal:'Força + hipertrofia'}
];